...
(function($) {
    ...
    $.fn.qtip = function(options) {
        ...
        // No API commands. validate provided options and setup qTips
            ...
            {
                var id, i, self, targets, events, namespace;
                ...
                events = { show: self.options.show.when.event, hide: self.options.hide.when.event };

                // If prerendering is disabled, create tooltip on show event
                if (self.options.content.prerender === false && self.options.show.ready !== true
    ...
    qTip.prototype.render = function() {
        ...
        // Apply a deprecated data holder to the target and tooltip
        self.elements.target.add(self.elements.tooltip).data('qtip', true);
    ...
    qTip.prototype.destroy = function() {
        ...
        i = interfaces.length; while (i--) if (interfaces[i] && interfaces[i].id == self.id) delete interfaces[i];
    ...
    function assignEvents() {
        ...
        if (events.hide == 'inactive') {
            ...
            $(events.inactive).each(function() {
                targets.hide.add(self.elements.content).bind(this + '.qtip-inactive', inactiveMethod);
            });
        }
        ...
        // Check if hide event is disabled
        ...
        // Define regular hide event method
        else {
