...
(function($) {
    ...
    $._timePicker = function(elm, settings) {
        ...
        // AJ tweak
        var txtHeight = $(elm).outerHeight();
        var txtWidth = $(elm).outerWidth();

        var elemId = $(elm).attr("Id");
        $tpDiv.insertBefore("#" + elemId).css({ 'margin-top': txtHeight, 'margin-left': 0 }).hide();
